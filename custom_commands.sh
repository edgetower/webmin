...
cat > $file_location <<EOF
sed -i "s/ET_API_PROFILE\=.*/ET_API_PROFILE=$var$PROFILE_ID/" "/home/edgetower/projects/edgetower/settings/.env" && sed -i "s/MQTT_TOPIC\=.*/MQTT_TOPIC=$var$TOKEN/" "/home/edgetower/projects/edgetower/settings/.env" && echo "Updated the Profile id.."
